...
OPTIONS_DE = {
    ...
    11: ["verbindungslos", "medienabhängig", "Segmentierung von Nutzerdaten", "zuverlässige End-to-End-Übertragung"],
    ...
    17: ["direkt verbundene Routen", "lokale Routen", "Remote-Routen", "C- und L-Quellrouten"],
    18: [
    ...
    29: ["Neighbor-Tabelle", "ARP-Cache", "Routing-Tabelle", "MAC-Adresstabelle"],
    30: [
        "Quell-MAC-Adresse",
        "Quell-IP-Adresse",
        "Ziel-MAC-Adresse",
    ...
    41: ["R1> → enable", "R1# → copy running-config startup-config", "R1(config-line)# → login", "R1(config)# → interface fastethernet 0/0"],
    42: [
    ...
    45: ["Der Inhalt des ROM ändert sich.", "Der Inhalt des RAM ändert sich.", "Der Inhalt des NVRAM ändert sich.", "Der Inhalt des Flash ändert sich."],
    46: [
