const QUESTIONS = [
  ...
  },
  {
    ...
    "explanation": "**4\\. Which IPv4 address can a host use to ping the loopback interface?**\n\n* 126.0.0.1\n* 127.0.0.0\n* 126.0.0.0\n* **127.0.0.1**\n\n**Explanation:** Topic 8.4.1",
    "topic": "Topic 8.5.1",
    "image": null,
    "exhibit": null,
  ...
  },
  {
    ...
    "module": 9,
    "type": "single",
    "question": "Refer to the exhibit. PC1 attempts to connect to File\\_server1 and sends an ARP request to obtain a destination MAC address. Which MAC address will PC1 receive in the ARP reply?",
    "options": [
  ...
  },
  {
    ...
    "explanation": "**60\\. What property of ARP allows MAC addresses of frequently used servers to be fixed in the ARP table?**\n\n* **A static IP-to-MAC address entry can be entered manually into an ARP table.**\n* Entries in an ARP table are time-stamped and are purged after the timeout expires.\n* The type field 0x806 appears in the header of the Ethernet frame.\n* The port-to-MAC address table on a switch has the same entries as the ARP table on the switch.\n\n**Explanation:** Topic 9.2.4",
    "topic": "Topic 9.2.4",
    "image": null,
    "exhibit": null,
